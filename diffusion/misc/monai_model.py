...
class DDPMPL(pl.LightningModule):
    ...
    def validation_step(self, val_batch, batch_idx):
        ...
        noisy_images = self.scheduler.add_noise(original_samples=images, noise=noise, timesteps=timesteps)
        ...
        self.log("val_loss", loss, sync_dist=True, prog_bar=True, logger=True)
